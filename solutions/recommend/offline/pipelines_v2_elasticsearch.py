...
from pipelines_v2.modules import ElasticSearchRetrievalModule, ElasticSearchRetrievalConfig
...
if __name__ == '__main__':
    ...
    spark, session_confs, extended_confs = initSparkModule.run(return_conf=True)
    ...
    metric_dict = ElasticSearchRetrievalModule(spec['training']).\
        run(dataset_dict['train'], extended_confs=extended_confs)
