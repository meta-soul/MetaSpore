...
class FeatureSchemaParser {
  public:
    static status parse(const std::string &file, FeatureComputeExec &exec);
    static status parse_new_format(std::istream &is, FeatureComputeExec &exec);
