...
def train(spark, train_dataset, user_id_column_name, item_id_column_name, behavior_column_name,
          behavior_filter_value, key_column_name, value_column_name, use_plain_weight, 
          smoothing_coefficient, max_recommendation_count, **kwargs):
