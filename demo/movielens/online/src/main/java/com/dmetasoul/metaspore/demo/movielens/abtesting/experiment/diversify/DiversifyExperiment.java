...
public class DiversifyExperiment implements BaseExperiment<RecommendResult, RecommendResult> {
    ...
    protected DiverdifierContext diverdifierContext;
    ...
    public void initialize(Map<String, Object> map) {
        ...
        this.diverdifierContext = diverdifierContext;
        diverdifierContext.setDiversifierName((String) map.getOrDefault("diverisifier", "SimpleDiersifier"));
        System.out.println("diversify.base initialize, useDiversify:" + this.useDiversify
                + ", window:" + this.window
                + ", tolerance:" + this.tolerance
                + ",diverdifierMethod:" + this.diverdifierContext.getDiversifierName());
    }
    ...
    public RecommendResult run(Context context, RecommendResult recommendResult) {
        ...
        List<ItemModel> diverseItemModels = diversifierService.diverse(diverdifierContext, itemModel, this.window, this.tolerance);
