...
package com.dmetasoul.metaspore.demo.multimodal.abtesting.layer.txttoimg;
...
@LayerAnnotation(name = "summary.t2i")
@Component
public class TxttoimgSummaryLayer implements BaseLayer<SearchResult> {
    private LayerBucketizer bucketizer;

    @Override
    public void intitialize(LayerArgs layerArgs) {
        System.out.println("[TxtToImg] Summary layer, args:" + layerArgs);
    ...
    public String split(Context ctx, SearchResult in) {
        ...
        System.out.printf("[TxtToImg] Summary layer split: %s, return exp: %s%n", this.getClass().getName(), returnExp);
        return returnExp;
    }
}
