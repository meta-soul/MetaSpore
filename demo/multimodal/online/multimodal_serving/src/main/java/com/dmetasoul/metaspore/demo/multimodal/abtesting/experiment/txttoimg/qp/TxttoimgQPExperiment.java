...
package com.dmetasoul.metaspore.demo.multimodal.abtesting.experiment.txttoimg.qp;
...
@ExperimentAnnotation(name = "qp.t2i.base")
@Component
public class TxttoimgQPExperiment implements BaseExperiment<SearchResult, SearchResult> {
    private String modelName;
    private String processorName;
    protected final QpService qpService;

    public TxttoimgQPExperiment(QpService qpService) {
    ...
    public void initialize(Map<String, Object> args) {
        ...
        System.out.println("[TxtToImg] qp.base initialize... " + args);
    }
    ...
    public SearchResult run(Context ctx, SearchResult in) {
        ...
        System.out.println("[TxtToImg] qp.base experiment, userModel:" + searchContext.getUserId() + ", Query:" + in.getSearchQuery());
        return in;
    }
}
