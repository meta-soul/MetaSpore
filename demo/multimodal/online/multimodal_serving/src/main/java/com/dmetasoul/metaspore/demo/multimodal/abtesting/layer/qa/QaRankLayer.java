...
@LayerAnnotation(name = "rank.qa")
@Component
public class QaRankLayer implements BaseLayer<SearchResult> {
    private LayerBucketizer bucketizer;

    @Override
    public void intitialize(LayerArgs layerArgs) {
        System.out.println("QA Rank layer, args:" + layerArgs);
    ...
    public String split(Context ctx, SearchResult in) {
        ...
        System.out.printf("QA Rank layer split: %s, return exp: %s%n", this.getClass().getName(), returnExp);
        return returnExp;
    }
}
